      					...
      					<div class="col l12">
      							...
      							<div class="row">
								     <div class="input-field col l12">
								      	...
								      	<input id="searchuser" type="text" name="search" required>
								      	<label for="searchuser">Search by Username</label>
								     </div>
								</div>
								<div class="row center">
								      <div class="input-field col l12">
								      	<button onclick="searchuser()" class="btn btn-floating btn-large waves-effect"><i class="mdi-navigation-arrow-forward"></i></button>
								      	</div>
								     </div>
